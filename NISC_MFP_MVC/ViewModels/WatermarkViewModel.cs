...
namespace NISC_MFP_MVC.ViewModels
{
    public class WatermarkViewModel
    {
        ...
        [DisplayName("填滿方式")] public string fill_mode { get; set; }

        [DisplayName("文字")] public string text { get; set; }

        [DisplayName("圖片位置")] public string image_path { get; set; }
        ...
        [DisplayName("顏色")] public string color { get; set; }
        ...
        [DisplayName("字型")] public string font_name { get; set; }
