...
namespace NISC_MFP_MVC_Repository.DTOs.InitialValue
{
    public class InitialDepositRepoDTO
    {
        ...
        public Nullable<int> deposit_value { get { return _deposit_value; } set { _deposit_value = value ?? 0; } }
        public Nullable<int> pbalance { get { return _pbalance; } set { _pbalance = value ?? 0; } }
        public Nullable<int> final_value { get { return _final_value; } set { _final_value = value ?? 0; } }
