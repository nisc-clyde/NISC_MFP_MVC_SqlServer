...
namespace NISC_MFP_MVC_Service.Implement
{
    public class MultiFunctionPrintService : IMultiFunctionPrintService
    {
        ...
        public IQueryable<MultiFunctionPrintInfo> GetMultiple(int cr_id)
        {
            if (cr_id <= 0)
            {
                throw new ArgumentNullException(nameof(cr_id), "cr_id卡機編號不得小於等於零");
            }
            else
            {
        ...
        {
            instance = instance ?? throw new ArgumentNullException(nameof(instance), "Reference to null instance.");
            cr_id = cr_id <= 0 ? throw new ArgumentNullException(nameof(cr_id), "cr_id卡機編號不得小於等於零") : cr_id;
        ...
        {
            cr_id = cr_id ?? throw new ArgumentNullException(nameof(cr_id), "Reference to null instance.");
